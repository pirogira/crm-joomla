...
Использовал Cursor для ускорения: генерация DDL, CRUD, State-классов. Промпты формулировал с явными ограничениями («crm_events — единственный источник истины»). Проверял результат тестами и ручным прогоном. AI помог с бойлерплейтом, архитектуру и бизнес-правила делал сам.
